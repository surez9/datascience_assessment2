...
# Average Yellow Cards Comparison
...
fig.suptitle("Total Yellow Cards \u2014 Defenders vs Midfielders", fontsize=13, fontweight="bold", y=0.99)
...
fig.suptitle(" Card-Count Distribution \u2014 Defenders vs Midfielders", fontsize=13, fontweight="bold", y=0.99)
